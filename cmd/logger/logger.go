...
// and GOROOT directories. Also append github.com/zhaohuxing/minio
...
func Init(goPath string, goRoot string) {
	...
	// Add "github.com/zhaohuxing/minio" as the last to cover
	// paths like "{GOROOT}/src/github.com/zhaohuxing/minio"
	// and "{GOPATH}/src/github.com/zhaohuxing/minio"
